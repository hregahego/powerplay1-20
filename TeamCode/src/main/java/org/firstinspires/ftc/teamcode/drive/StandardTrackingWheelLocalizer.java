...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 4.244039; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -2.25; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 1.0048; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.09412518; // Multiplier in the Y direction
